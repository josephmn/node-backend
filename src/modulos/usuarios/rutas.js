...
router.post('/', seguridad(), insertar); // crear un nuevo cliente
router.put('/', seguridad(), actualizar); // actualizar un cliente
router.delete('/', seguridad(), eliminar); // eliminar un cliente
